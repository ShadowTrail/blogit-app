const page = () => {
  return (
    <>
      <div className="max-w-2xl font-serif space-y-10 text-xl p-10">
        <h2 className="font-bold: font-weight:700  text-8xl">
          Everyone has a story to tell.
        </h2>
        <p>
          Blogger's Stop is a home for human stories and ideas.Here, anyone can
          share knowledge and wisdom with the world—without having to build a
          mailing list or a following first. The internet is noisy and chaotic;
          Blogger's Stop is quiet yet full of insight. It’s simple, beautiful,
          collaborative, and helps you find the right readers for whatever you
          have to say.
        </p>
        <h3 className="font-sans font-weight:400">
        ...
        <p>
          Over 100 million people connect and share their wisdom on Blogger's
          Stop every month. They’re software developers, amateur novelists,
          ...
          what’s keeping them up at night, what they’ve lived through, and what
        ...
        <p>
          ...
          growing community of over a million Blogger's Stop members who believe
          in our mission. If you’re new here, start reading. Dive deeper into
